  ...
  <div class="table-container">
    ...
    <div class="search-bar">
      ...
      <div class="button-group">
        ...
        <el-button type="success" class="action-btn" @click="handleAdd">新增入库单</el-button>
      </div>
    </div>
...
const originalTableData = [
  {
    ...
    warehouse_id: 'W001',
    supplier_id: 'S001',
    inbound_time: '2023-10-01 09:30:00',
    status: '已入库',
  },
  {
    inbound_id: 'I002',
    warehouse_id: 'W001',
    supplier_id: 'S002',
    inbound_time: '2023-10-02 14:15:00',
    status: '已审核',
  },
  {
    inbound_id: 'I003',
    warehouse_id: 'W002',
    supplier_id: 'S003',
    inbound_time: '2023-10-03 10:00:00',
    status: '待审核',
  },
  {
    inbound_id: 'I004',
    warehouse_id: 'W003',
    supplier_id: 'S001',
    inbound_time: '2023-10-04 16:45:00',
    status: '已入库',
  },
  {
    inbound_id: 'I005',
    warehouse_id: 'W002',
    supplier_id: 'S004',
    inbound_time: '2023-10-05 09:10:00',
    status: '取消',
  },
]
...
const handleEdit = (index, row) => {
  alert(`编辑索引: ${index}, 入库单ID: ${row.inbound_id}`)
}
const handleDelete = (index, row) => {
  alert(`删除索引: ${index}, 入库单ID: ${row.inbound_id}`)
}
</script>
